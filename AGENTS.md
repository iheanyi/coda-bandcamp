...
- **Surprise Me** is contextual. It chooses either one track or one multi-track
  release from the artist, album, search results, genre, Recent, Singles,
  Albums, or Collection currently being viewed. A release queues its complete
  tracklist in album order, and the action must not hydrate the whole scope.
  The tray action explicitly named **Surprise Me** remains global.
